                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    //pvec求垂直于dir和edge2的向量
    //若相交，pvec与edge1形成的平面与三角形形成夹角，且法线方向朝向三角形里面
    Vector3f pvec = crossProduct(dir, edge2);
    //det表明了pvec与edge1的夹角
    float det = dotProduct(edge1, pvec);
    //若det为0，说明pvec与edge1平行，即dir与edge1和edge2共面，不相交
    //若det为负，说明pvec与edge1反向，即dir与edge1和edge2背面，不相交
    if (det == 0 || det < 0)
        return false;
